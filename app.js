...
// refs.modal.addEventListener('keydown', onArrowRight);
// refs.modal.addEventListener('keydown', onArrowLeft);
...
//     if (currentIdx + 1 > galleryItems.length - 1) {
//         currentIdx = 0
//     } else {
//         currentIdx += 1
//     }
//     refs.modalContent(
//         galleryItems[currentIdx].original,
//         galleryItems[currentIdx].description
//     )
// }

// function onArrowLeft() {
//     if (currentIdx - 1 < 0) {
//         currentIdx = galleryItems.length - 1
//     } else {
//         currentIdx -= 1
//     }
//     refs.modalContent(
